...
public class ConstanteRequeteSql {
	...
	public final static String QUERY_ORDER_DESC= "SELECT computer.id, computer.name, introduced, discontinued, company_id, company.name FROM computer LEFT JOIN company ON company_id = company.id ORDER BY computer.name DESC  LIMIT ? , ? ";
	public final static String QUERY_ORDER_ASC= "SELECT computer.id, computer.name, introduced, discontinued, company_id, company.name FROM computer LEFT JOIN company ON company_id = company.id ORDER BY computer.name ASC  LIMIT ? , ? ";
	...
	public final static String QUERY_DELETE_BY_COMPANY ="DELETE FROM computer LEFT JOIN company ON company_id = company.id WHERE company.name LIKE ? ";
}
