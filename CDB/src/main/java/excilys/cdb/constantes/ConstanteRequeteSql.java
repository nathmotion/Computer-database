...
public class ConstanteRequeteSql {
	...
	public final static String QUERY_ORDER_COMPÜTER= "SELECT computer.id, computer.name, introduced, discontinued, company_id, company.name FROM computer LEFT JOIN company ON company_id = company.id ORDER BY computer.name ?  LIMIT ? , ? ";
	...
	public final static String QUERY_ORDER_COMPANY= "SELECT computer.id, computer.name, introduced, discontinued, company_id, company.name FROM computer LEFT JOIN company ON company_id = company.id ORDER BY company.name ?  LIMIT ? , ? ";
